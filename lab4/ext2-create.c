...
// block 22 is reserved at block 22
...
void write_inode_table(int fd) {
	...
	lost_and_found_inode.i_mode = EXT2_S_IFDIR // d
	                              | EXT2_S_IRUSR // r
	                              | EXT2_S_IWUSR // w
	                              | EXT2_S_IXUSR // d
	                              | EXT2_S_IRGRP // r
	...
	hello_inode.i_mode = EXT2_S_IFLNK // l
							| EXT2_S_IRUSR // r
							| EXT2_S_IWUSR // w
							| EXT2_S_IRGRP // r
							| EXT2_S_IROTH; // r
	...
	hello_world_inode.i_mode = EXT2_S_IFREG // f
							| EXT2_S_IRUSR // r
							| EXT2_S_IWUSR // w
							| EXT2_S_IRGRP // r
							| EXT2_S_IROTH; // r
	...
	root_inode.i_mode = EXT2_S_IFDIR // d
	                              | EXT2_S_IRUSR // r
	                              | EXT2_S_IWUSR // w
	                              | EXT2_S_IXUSR // d
	                              | EXT2_S_IRGRP // r
